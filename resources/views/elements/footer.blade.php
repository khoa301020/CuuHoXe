            ...
            <div class="row">
                    ...
                    <div class="ztl-widget-info-1">
                        ...
                        <div class="ztl-widget-info">
                            <div class="ztl-widget-info-image">
                                <img src="{{asset('public/frontend/images/support-24-hours.png')}}">
                            </div>
                ...
                <aside id="autoresq_info_widget-4" class="widget col-md-4 widget_autoresq_info_widget">
                    <div class="ztl-widget-info-4">
                        ...
                        <div class="ztl-widget-info">
                            <div class="ztl-widget-info-image">
                                <img src="{{asset('public/frontend/images/nation-wide.png')}}">
                            </div>
                            <span class="ztl-widget-info-description">
                                <span style="font-size:12px;color:#f4c70b">HỖ TRỢ TRÊN ĐÀ NẴNG</span><br>
                                <span style="font-size:18px;font-weight:600">6 HUYỆN VÀ 2 QUẬN</span> </span>
                        </div>
